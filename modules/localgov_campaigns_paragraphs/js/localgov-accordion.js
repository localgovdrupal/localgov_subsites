    ...
    init: function init(accordion, index) {
          ...
          button.addEventListener('click', function (e) {
            ...
            if (e.target.getAttribute('aria-expanded') === 'false') {
              ...
              if (openPane.length) {
                ...
                var openPaneButton = accordion
                  .querySelectorAll('[aria-controls="' + openPaneId + '"]');
      ...
      var destroy = function destroy() {
        for (var i = 0; i < numberOfPanes; i++) {
          ...
          var button = accordion.querySelectorAll('.accordion-pane__title')[i]
          ...
          accordionPanes[i].querySelectorAll('.accordion-pane__content')[0]
            .removeAttribute('id');

          // Remove open class from accordion pane's content elements.
          if (accordionPanes[i].querySelectorAll('.accordion-pane__content')[0]
