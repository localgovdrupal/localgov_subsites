...
(function () {
  Drupal.behaviors.tabs = {
    ...
    attach: function attach(context) {
      var tabs = context.querySelectorAll('[data-tabs]');
    ...
    init: function init(tabs, index) {
        ...
        if (!tabs.classList.contains(tabsInitialisedClass)) {
          var _ret = function () {
            ...
            var _loop = function _loop(i) {
              ...
              var tabPanelTitle = tabPanels[i]
                .querySelectorAll('.tab-panel__title')[0]
                .textContent;
              ...
              tab.addEventListener('click', function (e) {
                ...
                if (isActive === 'false') {
                  Drupal.behaviors.tabs.switchTab(e.currentTarget, tabs);
                }
              });
                  ...
                  case 37:
                    ...
                    if (i - 1 >= 0) {
                      newActiveControl = tabList
                        .querySelectorAll('li')[i - 1]
                        .querySelectorAll('button');
                      Drupal.behaviors.tabs.switchTab(newActiveControl[0], tabs);
      ...
      var destroy = function destroy() {
        if (tabs.classList.contains(tabsInitialisedClass)) {
          // Remove tabs.
          tabs.querySelectorAll('.tabs__nav')[0].remove();
          ...
          for (var i = 0; i < tabPanels.length; i++) {
            ...
            if (tabs.querySelectorAll('.tab-panel--active').length > 0) {
              tabs.querySelectorAll('.tab-panel--active')[0].classList
                .remove('tab-panel--active');
            }
          }
    ...
    switchTab: function switchTab(newActiveTab, tabs) {
      ...
      if (tabs.querySelectorAll('.' + activePanelClass).length > 0) {
        tabs.querySelectorAll('.' + activePanelClass)[0].classList
          .remove(activePanelClass);
      }
